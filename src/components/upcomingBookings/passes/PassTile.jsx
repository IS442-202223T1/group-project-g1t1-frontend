...
export default function PassTile({
  ...
  return (
    <div className="mb-5 rounded-lg flex flex-col md:flex-row border hover:shadow-lg">
      <img
        className="object-cover w-full h-96 rounded-t-lg overflow-hidden md:w-60 md:h-auto md:rounded-none md:rounded-l-lg"
        src={imageUrl === null || imageUrl === "" ? defaultImageUrl : imageUrl}
        alt="nature"
      />
          ...
          <>
            <p className="mb-3 font-normal text-gray-700">
              ...
              <span className="font-medium text-black">
                {displayedPrevBookerDate.toDateString()}
              </span>
            </p>
            <p className="mb-3 font-normal text-gray-700">
            ...
            <p className="mb-3 font-normal text-gray-700">
              Previous Booker Contact Number:{" "}
              <span className="font-medium text-black">{prevBookerNum}</span>
            </p>
          </>
        ) : null}
        ...
        {status !== "CANCELLED" && (
          <div>
            <DefaultSecondaryButton
              ...
              onButtonClick={handleCancelBooking}
            />
          </div>
        )}
      </div>
